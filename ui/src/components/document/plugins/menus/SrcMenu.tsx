...
function SrcMenu(props) {
  ...
  function handleChange(event) {
    ...
    const tr = props.view.state.tr.setNodeMarkup(props.menu.from, null, { src: event.target.value })
  ...
  return (
    ...
    >
      <input type="text" value={value} onChange={handleChange} className="px-3 py-2" style={{ width: "60ch"}}/>
    </div>
  );
}
