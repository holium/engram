<template>
    <div class="flex flex-col gap-2" @drop="handleDrop" @dragover="handleDragOver">
        <div class="py-2 flex items-center opacity-50" style="color: var(--rlm-icon-rgba, #333333)" id="workspace-heading" @contextmenu="openMenu">
            <div class="heading-1 color-icon">
                {{ space.name }}
            </div>
            <div class="flex-grow mx-3" style="border-top: 1px solid; height: 0px; border-color: var(--rlm-icon-rgba, #333333)">
